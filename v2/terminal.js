...
(function () {
  ...
  async function cmdResume() {
    const lines = [
      ...
      ['it-dim',            '└─────────────────────────────────────────────────────────┘'],
      ['', ''],
      ['it-white',          `  <a class="it-link" href="/v2/assets/resume/vajid-shaik-devops-resume.pdf" download>⬇  Download full resume (ATS-optimised PDF)</a>`],
    ];
  ...
  async function cmdSudoHire() {
    ...
    appendLine(`  <a class="it-link" href="/v2/assets/resume/vajid-shaik-devops-resume.pdf" download>📄  Download Resume (PDF)</a>`);
  }
